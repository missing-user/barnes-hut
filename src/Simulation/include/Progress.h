// Progress bar from the boost library
...
class progress_display 
{
 public:
  ...
  void restart( unsigned long expected_count_ ) noexcept
  ...
  unsigned long  operator+=( unsigned long increment ) noexcept
  ...
  unsigned long  operator++() noexcept  { return operator+=( 1 ); }
