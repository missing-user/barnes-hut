...
std::vector<Particle> &scale(std::vector<Particle> &particles, myfloat x, myfloat y, myfloat z)
{
	myvec3 scale{x, y, z};
...
std::vector<Particle> &translate(std::vector<Particle> &particles, myfloat x, myfloat y, myfloat z)
{
	myvec3 scale{x, y, z};
	for (auto &p : particles)
	{
...
std::vector<Particle> &add_velocity(std::vector<Particle> &particles, myfloat x, myfloat y, myfloat z)
{
	myvec3 scale{x, y, z};
	for (auto &p : particles)
	{
...
std::vector<Particle> &add_angular_momentum(std::vector<Particle> &particles, myvec3 axis)
{
	for (auto &p : particles)
	{
...
std::vector<Particle> &add_random_velocity(std::vector<Particle> &particles, myfloat x, myfloat y, myfloat z)
{
	myvec3 scale{x, y, z};
	for (auto &p : particles)
	{
...
std::vector<Particle> &set_maxwell_v_dist(std::vector<Particle> &particles, myfloat temperature)
{
...
std::vector<Particle> &add_radial_velocity(std::vector<Particle> &particles, myfloat scale)
{
	for (auto &p : particles)
	{
		p.v = p.p * scale;
...
{
	// A disk shaped universe with just 5k particles, will be used for performance eval eventually
