...
// /*
// // void Tree ::insertArray(std::vector<std::unique_ptr<Particle>> particles_in)
// // {
// //   std::vector<std::unique_ptr<Particle>> particles_passed;
// //   for (auto &p : particles_in)
// //   {
// //     if (level < maxDepth && (particles.size() >= maxParticles || !leaf))
// //     {
// //       particles_in.push_back(std::move(p));
// //     }
// //   }

// //   // need to construct the array first
// //   particles.insert(particles.end(), particles_in.begin(), particles_in.end()); // This is an STL vector fn. , not ours
// // }
...
// //     leaf = false;
// //     createBranches();
// //     for (const auto &pnt : particles)
// //     {
// //       branches[selectOctant(pnt->p)].insertArray(particles); //<-problem
// //     }
// //   }
// // }
// */
