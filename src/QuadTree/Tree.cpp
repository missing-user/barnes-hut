...
void Tree::createBranches() // populates the branches array of this object with new trees from subdividing this node
{
...
Particle Tree::computeCOM() // find the center of mass for this node and save it as the new COM
{
  Particle tempCOM;
...
myvec3 Tree::computeAcc(const Particle &particle, myfloat theta) const // compute the accelartion applied on a particle by this node
{
